#ifndef COBRAMODELPARSER_MATLABV5DATATYPETABLE_HPP
#define COBRAMODELPARSER_MATLABV5DATATYPETABLE_HPP

#include "MatlabV5DataType.hpp"
#include "CobraModelParser/Exceptions.hpp"

namespace CobraModelParser {
    class MatlabV5DataTypeTable {
    public:
        static MatlabV5DataType lookUp(size_t lookupValue) {
            ...
            switch (lookupValue) {
                case 0:
                    ...
                    return MatlabV5DataType(lookupValue, symbol, description);
                case 1:
                    symbol = "miINT8";
...
#endif //COBRAMODELPARSER_MATLABV5DATATYPETABLE_HPP
